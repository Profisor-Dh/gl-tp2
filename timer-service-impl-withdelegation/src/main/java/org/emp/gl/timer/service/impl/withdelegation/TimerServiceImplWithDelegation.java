...
public class TimerServiceImplWithDelegation
    ...
    private void updateSecode() {
        ...
        pcs.firePropertyChange(TimerChangeListener.SECONDE_PROP, oldValue, dixiemeDeSeconde);
    ...
    private void updateMinutes() {
        ...
        pcs.firePropertyChange(TimerChangeListener.MINUTE_PROP, oldValue, dixiemeDeSeconde);
        if (minutes == 0) {
            updateHeures();
        }
    }
    ...
    private void updateHeures() {
        ...
        pcs.firePropertyChange(TimerChangeListener.HEURE_PROP, oldValue, dixiemeDeSeconde);
    }
